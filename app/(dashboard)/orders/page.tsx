...
import { ArrowRight, Box, Check, ChevronDown, Plus, Truck } from "lucide-react"
...
const Orders = () => {
   ...
   const orders = [
    {
      id: 1,
      buyerName: 'Akinsanmi Akindale',
      amount: 'NGN134,320',
      code: "SFJRW3000",
      contact: '+2349384.......',
      time: '15/07/2025 12:32PM',
      Address: "30 Ogunsiji Cl, Off Adebayo Solake street, Allen Avenue, Ikeja, Lagos"
    },
     {
      id: 2,
      buyerName: 'Akinsanmi Akindale',
      ...
      <div className={`flex flex-col justify-center w-full bg-[#F0F0F0] p-5 rounded-[13px]  `} >
        ...
        setCurrentTab={setCurrentTab}
         ...
         <div className="p-5 ">
          ...
          <div className="mt-5 ">
            {orders.length > 0 && (
              <h2 className="text-[#03140A80] text-md ">Monday, 14th July, 2025</h2>
            )}
                ...
                <div className="w-full bg-white rounded-[12px] p-4 flex flex-col gap-4   " key={order.id}>
                  <div className="flex flex-col lg:flex-row gap-5   items-center justify-between">
                    <div className="flex flex-col lg:flex-row items-center gap-4 ">
                      <Image src={'/product1.jpg'} alt="product" width={60} height={60} />

                      <div className="">

                        <div className="flex  items-center gap-1 text-sm ">
                          <h2 className="text-[#03140A80] font-[500] ">Buyer name:</h2>
                          <span className="font-[600] ">{order.buyerName}</span>
                        </div>
  ...
  <AlertDialogContent>
    <AlertDialogHeader>
      <AlertDialogTitle className="flex flex-col items-center justify-center">Are you sure you want to decline this payment </AlertDialogTitle>
    ...
    <div className="flex flex-col gap-4 ">
      ...
      <Textarea placeholder="A message to your customer"
      className="bg-[#F0F0F0] "
    ...
    <AlertDialogFooter>
      ...
      onClick={() => {
       ...
       disabled={declineMessage === '' ? true : false} 
      className={` ${declineMessage !== '' && 'bg-[#ED2525] hover:bg-red-400'}`}
      >Decline payment</AlertDialogAction>
    </AlertDialogFooter>
  </AlertDialogContent>
</AlertDialog>
...
<AlertDialog onOpenChange={setDeclinePay} open={declinePay}>
  ...
  <AlertDialogContent>
    <AlertDialogHeader>
      <AlertDialogTitle className="flex items-center justify-center ">Payment declined!</AlertDialogTitle>
      <AlertDialogDescription>
           ...
           <div className="">
            <div className=" flex  gap-4 ">
              <h2 className="text-[#03140A80] ">Product Name: </h2>
                <span className="font-[700] " >XIAOMI Redmi 14C</span>
          
            </div>

            <div className=" flex  gap-4 ">
              <h2 className="text-[#03140A80] ">Amount paid:</h2>
                <span className="font-[700] "> NGN134,320</span>
    ...
    <AlertDialogFooter>
      <AlertDialogCancel className="w-full bg-[#27BA5F] hover:bg-green-400 hover:text-white rounded-[13px] text-white ">Close</AlertDialogCancel>
    </AlertDialogFooter>
  </AlertDialogContent>
</AlertDialog>
                     
                        <div className="cursor-pointer bg-[#27BA5F] w-[65px] h-[32px] flex flex-col justify-center rounded-full items-center">
                          <h2 className="text-sm text-white font-[700] ">Accept</h2>
                        </div>
                      </div>
                    )}
                    </div>
                      ...
                      <div className="">
                        ...
                        <div className="p-4 flex flex-col gap-2">
                          ...
                          <div className="flex items-center justify-between text-[#03140A80] ">
                            ...
                            <span className="w-[237px] text-right ">{order.Address}</span>
                          </div>
                        </div>
                      </div>
                    )}
      ...
      <DialogTitle>
        <div className="flex">
          {step.map((item) => (
            ...
            <span className={`text-[10px]  ${distributeStep === item.id ? 'text-[#27BA5F]' : 'text-[#03140A4D] '} `}>{item.title}</span>
          </div>
  ...
  <AlertDialogContent>
    ...
    <div className="">
      ...
      <div className="flex flex-col items-center justify-center  ">
        ...
        <span className="text-[#03140A80] text-sm w-[200px] text-center">Your product distribution has been initiated </span>
      </div>
    </div>
    
    <AlertDialogFooter>
      <AlertDialogCancel className="w-full bg-[#27BA5F] text-white hover:bg-green-400 hover:text-white rounded-[12px]">Close</AlertDialogCancel>
    </AlertDialogFooter>
  </AlertDialogContent>
</AlertDialog>
     ...
     <div className="flex items-center gap-4 ">
      {["Motorcycle", "Car"].map((item, index) => (
        <div className="flex items-center gap-2 cursor-pointer " onClick={() => setSelectedride(index)}  key={index}>
          ...
          <h2 className={` ${selectedride === index ? 'text-[#27BA5F] font-[500] ' : 'text-[#03140A80] '} text-sm `}>{item}</h2>
        </div>
      ))}
     </div>
    </div>
